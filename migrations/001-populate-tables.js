exports.up = async function (sql) {
  ...
  await sql`
    INSERT INTO rooms (hotel_id, price, capacity, extendable, damages, view, room_type_id, area) VALUES
        (1, 150, 2, False, NULL, 'Ocean View', 1, 20),
        (1, 160, 2, False, NULL, 'Ocean View', 1, 30),
        (1, 180, 2, False, NULL, 'Mountain View', 2, 20),
        (1, 200, 2, False, NULL, 'Ocean View', 2, 30),
        (1, 300, 4, False, TRUE, 'Ocean View', 3, 40),
        (1, 280, 4, False, TRUE, 'Ocean View', 3, 10),
        (2, 130, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (2, 140, 2, False, NULL, 'Ocean View', 1, 32),
        (2, 160, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (2, 170, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (2, 250, 2, TRUE, NULL, 'Mountain View', 3, 27),
        (3, 132, 2, False, NULL, 'Ocean View', 1, 22),
        (3, 142, 2, False, FALSE, 'Mountain View', 1, 35),
        (3, 164, 2, TRUE, TRUE, 'Ocean View', 2, 24),
        (3, 173, 4, TRUE, NULL, 'Ocean View', 2, 31),
        (3, 256, 2, TRUE, TRUE, 'Mountain View', 3, 29),
        (4, 101, 2, False, NULL, 'Mountain View', 1, 22),
        (4, 113, 2, False, FALSE, 'Mountain View', 1, 35),
        (4, 134, 2, TRUE, TRUE, 'Ocean View', 2, 24),
        (4, 157, 4, TRUE, NULL, 'Mountain View', 2, 31),
        (5, 90, 2, TRUE, NULL, 'Ocean View', 1, 20),
        (5, 102, 2, False, FALSE, 'Mountain View', 1, 30),
        (5, 123, 2, False, TRUE, 'Mountain View', 2, 22),
        (5, 135, 4, TRUE, NULL, 'Ocean View', 2, 33),
        (6, 103, 2, TRUE, NULL, 'Mountain View', 1, 23),
        (6, 114, 2, False, TRUE, 'Mountain View', 1, 34),
        (6, 136, 2, False, NULL, 'Ocean View', 2, 22),
        (6, 153, 4, TRUE, TRUE, 'Ocean View', 2, 30),
        (7, 153, 2, TRUE, NULL, 'Mountain View', 1, 22),
        (7, 165, 2, False, NULL, 'Ocean View', 1, 33),
        (7, 183, 2, TRUE, TRUE, 'Mountain View', 2, 22),
        (7, 202, 2, False, NULL, 'Mountain View', 2, 33),
        (7, 305, 4, False, TRUE, 'Ocean View', 3, 42),
        (7, 193, 4, TRUE, NULL, 'Ocean View', 3, 12),
        (8, 103, 2, TRUE, NULL, 'Mountain View', 1, 23),
        (8, 114, 2, False, NULL, 'Ocean View', 1, 36),
        (8, 135, 2, False, TRUE, 'Mountain View', 2, 24),
        (8, 158, 4, TRUE, TRUE, 'Ocean View', 2, 35),
        (9, 132, 2, TRUE, TRUE, 'Mountain View', 1, 21),
        (9, 144, 2, False, NULL, 'Ocean View', 1, 33),
        (9, 162, 2, False, TRUE, 'Mountain View', 2, 24),
        (9, 174, 4, TRUE, NULL, 'Mountain View', 2, 33),
        (9, 252, 2, False, NULL, 'Ocean View', 3, 22),
        (10, 132, 2, False, TRUE, 'Mountain View', 1, 20),
        (10, 142, 2, TRUE, TRUE, 'Mountain View', 1, 32),
        (10, 164, 2, False, NULL, 'Ocean View', 2, 23),
        (10, 174, 4, TRUE, TRUE, 'Ocean View', 2, 34),
        (10, 255, 2, TRUE, NULL, 'Mountain View', 3, 25),
        (11, 125, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (11, 138, 2, False, TRUE, 'Mountain View', 1, 32),
        (11, 162, 2, TRUE, TRUE, 'Ocean View', 2, 26),
        (11, 174, 4, False, NULL, 'Mountain View', 2, 33),
        (11, 248, 2, False, NULL, 'Mountain View', 3, 20),
        (12, 100, 2, False, NULL, 'Mountain View', 1, 22),
        (12, 110, 2, False, FALSE, 'Ocean View', 1, 35),
        (12, 130, 2, TRUE, TRUE, 'Ocean View', 2, 24),
        (12, 150, 4, False, NULL, 'Mountain View', 2, 31),
        (13, 102, 2, False, NULL, 'Ocean View', 1, 20),
        (13, 114, 2, TRUE, NULL, 'Mountain View', 1, 30),
        (13, 132, 2, TRUE, TRUE, 'Mountain View', 2, 20),
        (13, 154, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (14, 132, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (14, 143, 2, TRUE, NULL, 'Ocean View', 1, 32),
        (14, 164, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (14, 172, 4, False, NULL, 'Mountain View', 2, 30),
        (14, 253, 2, False, TRUE, 'Ocean View', 3, 27),
        (15, 103, 2, False, NULL, 'Mountain View', 1, 20),
        (15, 116, 2, False, NULL, 'Mountain View', 1, 35),
        (15, 133, 2, False, TRUE, 'Ocean View', 2, 25),
        (15, 156, 4, TRUE, NULL, 'Ocean View', 2, 30),
        (16, 80, 2, False, NULL, 'Ocean View', 1, 20),
        (16, 92, 2, False, NULL, 'Mountain View', 1, 35),
        (16, 94, 4, False, NULL, 'Ocean View', 1, 20),
        (16, 102, 4, False, NULL, 'Mountain View', 1, 35),
        (17, 129, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (17, 138, 2, False, NULL, 'Mountain View', 1, 34),
        (17, 162, 2, TRUE, TRUE, 'Ocean View', 2, 22),
        (17, 174, 4, False, TRUE, 'Ocean View', 2, 33),
        (17, 245, 2, False, NULL, 'Ocean View', 3, 24),
        (18, 160, 2, TRUE, NULL, 'Ocean View', 1, 20),
        (18, 170, 2, False, NULL, 'Ocean View', 1, 30),
        (18, 190, 2, TRUE, TRUE, 'Mountain View', 2, 20),
        (18, 210, 2, TRUE, NULL, 'Ocean View', 2, 30),
        (18, 310, 4, False, TRUE, 'Mountain View', 3, 40),
        (18, 290, 4, TRUE, NULL, 'Mountain View', 3, 10),
        (19, 130, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (19, 140, 2, False, NULL, 'Ocean View', 1, 32),
        (19, 160, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (19, 170, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (19, 250, 2, TRUE, NULL, 'Mountain View', 3, 27),
        (20, 135, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (20, 145, 2, False, NULL, 'Ocean View', 1, 30),
        (20, 165, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (20, 175, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (20, 255, 2, False, TRUE, 'Ocean View', 3, 25),
        (21, 85, 2, TRUE, NULL, 'Ocean View', 1, 20),
        (21, 95, 2, False, TRUE, 'Ocean View', 1, 30),
        (21, 115, 2, TRUE, NULL, 'Mountain View', 2, 22),
        (21, 125, 4, False, NULL, 'Ocean View', 2, 33),
        (22, 95, 2, False, NULL, 'Ocean View', 1, 20),
        (22, 105, 2, TRUE, False, 'Mountain View', 1, 30),
        (22, 125, 2, False, NULL, 'Mountain View', 2, 22),
        (22, 135, 4, TRUE, TRUE, 'Ocean View', 2, 33),
        (23, 90, 2, TRUE, NULL, 'Ocean View', 1, 20),
        (23, 100, 2, False, NULL, 'Ocean View', 1, 30),
        (23, 120, 2, TRUE, TRUE, 'Mountain View', 2, 20),
        (23, 130, 4, TRUE, NULL, 'Ocean View', 2, 30),
        (24, 100, 2, False, NULL, 'Mountain View', 1, 20),
        (24, 110, 2, TRUE, NULL, 'Mountain View', 1, 35),
        (24, 130, 2, TRUE, TRUE, 'Ocean View', 2, 25),
        (24, 157, 4, False, TRUE, 'Ocean View', 2, 30),
        (25, 130, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (25, 140, 2, False, NULL, 'Ocean View', 1, 32),
        (25, 160, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (25, 170, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (25, 250, 2, TRUE, NULL, 'Mountain View', 3, 27),
        (26, 135, 2, False, NULL, 'Ocean View', 1, 20),
        (26, 145, 2, False, NULL, 'Ocean View', 1, 30),
        (26, 165, 2, False, NULL, 'Mountain View', 2, 25),
        (26, 175, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (26, 255, 2, False, NULL, 'Mountain View', 3, 25),
        (27, 132, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        ...
        (29, 100, 2, TRUE, TRUE, 'Ocean View', 1, 30),
        (29, 125, 2, False, TRUE, 'Ocean View', 2, 20),
        (29, 135, 4, TRUE, NULL, 'Ocean View', 2, 30),
        (30, 100, 2, False, NULL, 'Mountain View', 1, 22),
        (30, 110, 2, False, TRUE, 'Mountain View', 1, 35),
        (30, 135, 2, False, NULL, 'Mountain View', 2, 24),
        (30, 155, 4, False, NULL, 'Mountain View', 2, 31),
        (31, 130, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (31, 140, 2, False, NULL, 'Ocean View', 1, 32),
        (31, 160, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (31, 170, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (31, 250, 2, TRUE, NULL, 'Mountain View', 3, 27),
        (32, 135, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (32, 145, 2, TRUE, TRUE, 'Ocean View', 1, 30),
        (32, 165, 2, TRUE, NULL, 'Mountain View', 2, 25),
        (32, 175, 4, TRUE, TRUE, 'Ocean View', 2, 30),
        (32, 255, 2, TRUE, NULL, 'Mountain View', 3, 28),
        (33, 132, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (33, 143, 2, False, NULL, 'Ocean View', 1, 32),
        (33, 164, 2, False, TRUE, 'Ocean View', 2, 25),
        (33, 172, 4, False, TRUE, 'Mountain View', 2, 30),
        (33, 252, 2, TRUE, NULL, 'Mountain View', 3, 27),
        (34, 105, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (34, 115, 2, TRUE, TRUE, 'Ocean View', 1, 35),
        (34, 135, 2, False, TRUE, 'Mountain View', 2, 25),
        (34, 155, 4, False, NULL, 'Mountain View', 2, 30),
        (35, 150, 2, False, NULL, 'Ocean View', 1, 20),
        (35, 160, 2, False, NULL, 'Ocean View', 1, 30),
        (35, 180, 2, False, NULL, 'Mountain View', 2, 20),
        (35, 200, 2, False, NULL, 'Ocean View', 2, 30),
        (35, 300, 4, False, TRUE, 'Ocean View', 3, 40),
        (35, 280, 4, False, TRUE, 'Ocean View', 3, 10),
        (36, 135, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (36, 145, 2, False, NULL, 'Ocean View', 1, 32),
        (36, 165, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (36, 175, 4, False, TRUE, 'Ocean View', 2, 30),
        (36, 255, 2, False, NULL, 'Mountain View', 3, 27),
        (37, 100, 2, False, NULL, 'Ocean View', 1, 25),
        (37, 115, 2, TRUE, TRUE, 'Ocean View', 1, 30),
        (37, 130, 2, TRUE, TRUE, 'Ocean View', 2, 25),
        (37, 155, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (38, 105, 2, TRUE, TRUE, 'Ocean View', 1, 20),
        (38, 115, 2, False, FALSE, 'Mountain View', 1, 35),
        (38, 135, 2, TRUE, TRUE, 'Ocean View', 2, 20),
        (38, 155, 4, TRUE, NULL, 'Mountain View', 2, 35),
        (39, 90, 2, TRUE, NULL, 'Ocean View', 1, 20),
        (39, 105, 2, TRUE, TRUE, 'Ocean View', 1, 30),
        (39, 125, 2, False, TRUE, 'Mountain View', 2, 20),
        (39, 135, 4, TRUE, NULL, 'Ocean View', 2, 35),
        (40, 135, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (40, 145, 2, False, NULL, 'Ocean View', 1, 30),
        (40, 165, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (40, 175, 4, False, NULL, 'Mountain View', 2, 30),
        (40, 250, 2, False, TRUE, 'Ocean View', 3, 25),
        (41, 100, 2, False, TRUE, 'Ocean View', 1, 22),
        (41, 115, 2, False, TRUE, 'Ocean View', 1, 35),
        (41, 135, 2, False, TRUE, 'Ocean View', 2, 24),
        (41, 150, 4, False, NULL, 'Mountain View', 2, 31),
        (42, 105, 2, False, NULL, 'Mountain View', 1, 22),
        (42, 110, 2, False, FALSE, 'Mountain View', 1, 35),
        (42, 130, 2, TRUE, TRUE, 'Ocean View', 2, 25),
        (42, 155, 4, False, TRUE, 'Ocean View', 2, 30),
        (43, 90, 2, False, TRUE, 'Ocean View', 1, 20),
        (43, 105, 2, False, FALSE, 'Mountain View', 1, 30),
        (43, 125, 2, False, TRUE, 'Ocean View', 2, 20),
        (43, 135, 4, TRUE, NULL, 'Ocean View', 2, 35),
        (44, 100, 2, TRUE, TRUE, 'Ocean View', 1, 22),
        (44, 115, 2, TRUE, TRUE, 'Mountain View', 1, 35),
        (44, 135, 2, False, TRUE, 'Ocean View', 2, 24),
        (44, 160, 4, TRUE, NULL, 'Ocean View', 2, 35),
        (45, 105, 2, False, NULL, 'Mountain View', 1, 22),
        (45, 115, 2, TRUE, TRUE, 'Mountain View', 1, 35),
        (45, 135, 2, TRUE, TRUE, 'Ocean View', 2, 25),
        (45, 155, 4, TRUE, NULL, 'Mountain View', 2, 30),
        (46, 135, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (46, 140, 2, False, NULL, 'Ocean View', 1, 35),
        (46, 165, 2, TRUE, NULL, 'Ocean View', 2, 25),
        (46, 170, 4, TRUE, TRUE, 'Ocean View', 2, 30),
        (46, 255, 2, False, TRUE, 'Mountain View', 3, 27),
        (47, 132, 2, TRUE, TRUE, 'Mountain View', 1, 20),
        (47, 144, 2, False, NULL, 'Ocean View', 1, 30),
        (47, 162, 2, TRUE, TRUE, 'Ocean View', 2, 25),
        (47, 174, 4, False, NULL, 'Ocean View', 2, 30),
        (47, 254, 2, False, TRUE, 'Mountain View', 3, 25),
        (48, 105, 2, False, NULL, 'Mountain View', 1, 22),
        (48, 115, 2, TRUE, NULL, 'Ocean View', 1, 35),
        (48, 135, 2, TRUE, TRUE, 'Ocean View', 2, 24),
        (48, 155, 4, False, NULL, 'Mountain View', 2, 31),
        (49, 160, 2, False, NULL, 'Mountain View', 1, 20),
        (49, 170, 2, False, NULL, 'Ocean View', 1, 30),
        (49, 190, 2, TRUE, TRUE, 'Mountain View', 2, 20),
        (49, 210, 2, False, TRUE, 'Mountain View', 2, 30),
        (49, 310, 4, False, TRUE, 'Mountain View', 3, 40),
        (49, 290, 4, False, TRUE, 'Ocean View', 3, 10),
        (50, 150, 2, False, NULL, 'Ocean View', 1, 20),
        (50, 160, 2, TRUE, TRUE, 'Ocean View', 1, 30),
        (50, 180, 2, False, NULL, 'Mountain View', 2, 20),
        (50, 200, 2, False, NULL, 'Ocean View', 2, 30),
        (50, 300, 4, False, TRUE, 'Ocean View', 3, 40),
